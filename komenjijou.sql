...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 23 fév. 2023 à 10:33
...
--
-- ALTER TABLE `jeux`
--   ADD CONSTRAINT `fk_own_category` FOREIGN KEY (`id_category`) REFERENCES `categories` (`id_category`);

--
-- Contraintes pour la table `utilisateurs`
--
ALTER TABLE `utilisateurs`
  ADD CONSTRAINT `fk_own_role` FOREIGN KEY (`id_role`) REFERENCES `roles` (`id_role`);
COMMIT;
